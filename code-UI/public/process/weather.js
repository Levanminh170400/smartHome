...
// Set data ban dau
fetch(
  `https://api.openweathermap.org/data/2.5/weather?q=Hà nội&appid=${APP_ID}&units=metric&lang=vi`
).then(async (res) => {
...
// Xem được thời tiết ở các khu vực bằng giọng nói
// Nghe được giờ tại thời điểm hiện tại
// Thay đổi màu lền
