...
const process = (content) => {
  btnLiving.forEach((value, index) => {
    let number = index + 1;
    if (content == "mở đèn " + number || content == "bật đèn " + number) {
      open(value, number);
    } else if (content == "tắt đèn " + number) {
      close(value, number);
    }
  });
  if (
    content == "mở tất cả đèn" ||
    content == "bật tất cả đèn" ||
    content == "bật tất cả thiết bị" ||
    content == "mở tất cả thiết bị"
  ) {
    btnLiving.forEach((value, index) => {
      open(value, index + 1);
    });
  } else if (content == "tắt tất cả đèn" || content == "tắt tất cả thiết bị") {
    btnLiving.forEach((value, index) => {
      close(value, index + 1);
    });
  }
  ...
  } else if (content == "tắt tất cả thiết bị phòng khách") {
    btnLiving.forEach((value, index) => {
      if (index < 3) {
        close(value, index + 1);
      }
  ...
  } else if (content == "tắt tất cả thiết bị phòng ngủ") {
    btnLiving.forEach((value, index) => {
      if (index > 2 && index < 6) {
        close(value, index + 1);
      }
  ...
  } else if (content == "tắt tất cả thiết bị ngoài nhà") {
    btnLiving.forEach((value, index) => {
      if (index > 5) {
        close(value, index + 1);
      }
